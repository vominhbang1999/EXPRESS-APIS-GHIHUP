	...
	upload(req, res, function (err) {
		if (err) {
			...
			var myData = new User({
				...
				avatar2: './public/uploads/' + req.files[0].filename,
				avatar3: './public/uploads/' + req.files[0].filename,
				avatar4: './public/uploads/' + req.files[0].filename,
				avatar5: './public/uploads/' + req.files[0].filename,
				avatar6: './public/uploads/' + req.files[0].filename,
				avatar7: './public/uploads/' + req.files[0].filename,
				hash: hashPass
			});
